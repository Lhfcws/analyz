...
public class DaoBase {
	 ...
	 * @throws SQLException
	 */
	public <T> List<T> findBeans(String sql, Class<T> entityClass,
    ...
    public Integer  insertWithKey(String sql, Object... params) throws SQLException{
    	...
    	try {
			...
			logger.error("Error occured while attempting to insertwithkey", e);
			e.printStackTrace();
			throw e;
		}
    ...
    public List<Integer>  insertWithKey(String sql, List<Object[]> params) throws SQLException{
    	...
    	try {
			...
			logger.error("Error occured while attempting to insertwithkey batch", e);
			e.printStackTrace();
			throw e;
		}
    ...
    /**
     * 在mysql中模拟序列，拿到一个序列值
     * @param sequenceName 所模拟序列用到的表的表名
     * @return
     * @throws SQLException 
     */
    public Integer getSequence(String sequenceName) throws SQLException{
    	...
    	try {
			...
			logger.error("Error occured while obtain sequence", e);
			e.printStackTrace();
			throw e;
		}
	 ...
	 * @return
	 */
	final protected int getSumIntArray(int[] rows){
